...
cl_client_context = import_module("github.com/crytic/eth-network-package/src/cl/cl_client_context.star")
cl_node_metrics = import_module("github.com/crytic/eth-network-package/src/cl/cl_node_metrics_info.star")
cl_node_ready_conditions = import_module("github.com/crytic/eth-network-package/src/cl/cl_node_ready_conditions.star")
...
def get_config(
	...
	# See: https://github.com/crytic/eth2-merge-kurtosis-module/issues/26
	cmd = [
		"mkdir",
